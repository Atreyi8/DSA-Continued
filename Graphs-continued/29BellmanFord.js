...
//Bellman Ford says Relax all the edges for n-1 iteration
//If there is a negative cycle then it will be detected in nth iteration
//If there is no negative cycle then the shortest path will be calculated in n-1 iteration
//Relaxation of edges means = if dist[u] + wt < dist[v] then dist[v] = dist[u] + wt
